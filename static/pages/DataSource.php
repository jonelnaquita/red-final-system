...
<div class="container-scroller">
  ...
  <tbody>
    <?php
    if (($handle = fopen("files/faq_sheet.csv", "r")) !== false) {
      $rowCount = 0;
          ...
          <td>
            <div class="form-check form-check-flat form-check-primary">
              <label class="form-check-label">
                <input type="checkbox" class="form-check-input" value="<?php echo $rowCount; ?>">
              </label>
            </div>
          </td>
          <td style="max-width: 400px">
            <div class="accordion accordion-filled" id="accordion-<?php echo $rowCount; ?>" role="tablist">
              <div class="card">
                <div class="card-header" role="tab" id="heading-<?php echo $rowCount; ?>">
                  <h6 class="mb-0">
                    <a data-bs-toggle="collapse" href="#collapse-<?php echo $rowCount; ?>" aria-expanded="false" aria-controls="collapse-<?php echo $rowCount; ?>" class="collapsed">
                      <?php echo $question; ?>
                    </a>
                  </h6>
                </div>
                <div id="collapse-<?php echo $rowCount; ?>" class="collapse" role="tabpanel" aria-labelledby="heading-<?php echo $rowCount; ?>" data-bs-parent="#accordion-<?php echo $rowCount; ?>" style="">
                  <div class="card-body">
                    <p class="mb-0"><?php echo $answer; ?></p>
                  </div>
                </div>
              </div>
            </div>
